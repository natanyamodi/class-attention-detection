...
def calibrate(calib_frame_count=25):
    ...
    vid = "C:/Users/Natanya Modi/OneDrive/Desktop/Projects/attention-span-detection/video.mp4"
...
def infer_video(video_path, ears_norm, mars_norm, pucs_norm, moes_norm):
    ...
    puc_main = 0
    moe_main = 0
    decay = 0.9  # use decay to smooth the noise in feature values
...
try:
    ...
    time.sleep(1)
    infer_video(video_path, ears_norm, mars_norm, pucs_norm, moes_norm)
